...
% Tekrarlanan başlık ve "devam ediyor" alt satırı sayfa kavramına bağlıdır.
% EPUB modunda boş bırakılır; tablo hizalaması içinde \ifdefined dallanması
% yapılamadığından (& hücre sınırı koşul atlamayı keser) makro dışarıda tanımlanır.
\ifdefined\HCode
\def\ltdevam{}
\else
\def\ltdevam{%
...
% Tekrarlanan başlık/alt satır: sayfa kavramına bağlı, EPUB'da boş (bkz. RV32I tablosu).
\ifdefined\HCode
\def\ltdevam{}
\else
\def\ltdevam{%
