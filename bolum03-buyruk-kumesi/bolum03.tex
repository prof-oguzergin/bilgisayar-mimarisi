...
Bu buyruk \texttt{not s2, s2} sözde buyruğuna karşılık gelir. Anlık değer $-1$, 32 bite işaretle genişletildiğinde tüm 32 bitin 1 olduğu $(\text{FFFFFFFF})_{16}$ değerini üretir ve Dışlayan VEYA işlemi her biti tersine çevirir: $a \oplus 1 = \overline{a}$ olduğundan bu yöntem DEĞİL ile aynı sonucu verir.
\end{ornek}
