...
% EPUB modunda TikZ kapak yerine raster kapak görseli kullanılır;
% \coverimage görseli hem ilk sayfaya koyar hem EPUB kapağı olarak kaydeder.
\ifdefined\HCode
\author{Oğuz Ergin}
\thispagestyle{empty}
\coverimage[width=\linewidth]{docs/kapak.jpg}
\clearpage
\else
\input{kapak}
\fi
...
% İçindekiler
% EPUB'da içindekiler hem kitap içi sayfa hem EPUB gezinme (nav) belgesinin
% kaynağıdır; şekil/tablo listeleri yalnızca PDF'te yer alır.
\tableofcontents
...
% Dizin (EPUB'da dizin düşük değerli; yalnızca PDF'te basılır)
\ifdefined\HCode\else
\printindex
\fi
